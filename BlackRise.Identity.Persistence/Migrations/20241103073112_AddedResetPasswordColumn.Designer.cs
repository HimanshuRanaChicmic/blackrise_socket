...
namespace BlackRise.Identity.Persistence.Migrations
{
    ...
    [Migration("20241103073112_AddedResetPasswordColumn")]
    partial class AddedResetPasswordColumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlackRise.Identity.Domain.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 11, 3, 7, 31, 11, 303, DateTimeKind.Utc).AddTicks(4977),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedBy = new Guid("912c3a8a-d59d-4b7d-876a-3dd93a21c461"),
                            ModifiedDate = new DateTime(2024, 11, 3, 7, 31, 11, 303, DateTimeKind.Utc).AddTicks(4979),
                            Name = "SuperAdmin",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("912c3a8a-d59d-4b7d-876a-3dd93a21c461"),
                            CreatedDate = new DateTime(2024, 11, 3, 7, 31, 11, 303, DateTimeKind.Utc).AddTicks(4987),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedBy = new Guid("912c3a8a-d59d-4b7d-876a-3dd93a21c461"),
                            ModifiedDate = new DateTime(2024, 11, 3, 7, 31, 11, 303, DateTimeKind.Utc).AddTicks(4988),
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("912c3a8a-d59d-4b7d-876a-3dd93a21c461"),
                            CreatedDate = new DateTime(2024, 11, 3, 7, 31, 11, 303, DateTimeKind.Utc).AddTicks(4994),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedBy = new Guid("912c3a8a-d59d-4b7d-876a-3dd93a21c461"),
                            ModifiedDate = new DateTime(2024, 11, 3, 7, 31, 11, 303, DateTimeKind.Utc).AddTicks(4995),
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("BlackRise.Identity.Domain.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = new Guid("912c3a8a-d59d-4b7d-876a-3dd93a21c461"),
                            CreatedDate = new DateTime(2024, 11, 3, 7, 31, 11, 303, DateTimeKind.Utc).AddTicks(6913),
                            ...
                            ModifiedBy = new Guid("912c3a8a-d59d-4b7d-876a-3dd93a21c461"),
                            ModifiedDate = new DateTime(2024, 11, 3, 7, 31, 11, 303, DateTimeKind.Utc).AddTicks(6916),
                            NormalizedEmail = "SUPER-ADMIN@BLACKRISE.COM",
                            NormalizedUserName = "SUPER-ADMIN@BLACKRISE.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAELPI2jXdT+Gr8tOihc1UWZEa5MI4ZLKLuOYNfqMWSgUI/bN9/y33ksTNWYjPsQ7grA==",
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 11, 3, 7, 31, 11, 404, DateTimeKind.Utc).AddTicks(3026),
                            ...
                            ModifiedDate = new DateTime(2024, 11, 3, 7, 31, 11, 404, DateTimeKind.Utc).AddTicks(3031),
                            NormalizedEmail = "ADMIN@BLACKRISE.COM",
                            NormalizedUserName = "ADMIN@BLACKRISE.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEM3Qs3TFwtvRkqbrYYQHqz9eK8lSzvtuRSnHtSTTa+Dihzoch1f0rXB5v3dbh1E9cg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "b43e9e94-17a5-4f93-bb9f-2ebbf412187a",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("a901293b-f4cd-4b50-93da-158bc435c1f9"),
                            CreatedDate = new DateTime(2024, 11, 3, 7, 31, 11, 492, DateTimeKind.Utc).AddTicks(4032),
                            ...
                            LockoutEnabled = false,
                            ModifiedBy = new Guid("8494a3ad-b74b-4407-a9ff-7a3f0c17770d"),
                            ModifiedDate = new DateTime(2024, 11, 3, 7, 31, 11, 492, DateTimeKind.Utc).AddTicks(4039),
                            NormalizedEmail = "USER@BLACKRISE.COM",
                            NormalizedUserName = "USER@BLACKRISE.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEAgem6F/EBbyD/Ljjc0nrvDc8ZNUisLQHk7qEA6Pkeaafs6DOg48maNpL4HMuphFVg==",
                            PhoneNumberConfirmed = false,
